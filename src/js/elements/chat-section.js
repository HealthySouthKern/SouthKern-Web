...
class ChatSection extends Element {
  ...
  Chat
   */
  createChatBoard(channelUrl, isLast, channelType) {
    console.log('createchatboard')
    //document.getElementById('sb_widget').style.display = 'none';
    ...
    this._setContent(chatTitle, channelType !== 'open' ? TITLE_CHAT_TITLE_DEFAULT : 'Open Channel');
  ...
  closeChatBoard(target) {
    console.log('chat closechatboard')
